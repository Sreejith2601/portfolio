          ...
          <div className="lg:flex lg:items-center lg:justify-between">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-gray-600 mb-8">
                I am a passionate MCA student at Kumaraguru College of Technology, with a strong foundation in computer science and a keen interest in web development. I specialize in web development and have experience with various modern technologies.
              </p>
      ...
      <section id="projects" className="py-20 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              <h3 className="text-xl font-semibold text-purple-600 mb-2">Smart Athelete Performance Monitoring And Training System</h3>
              <p className="text-gray-600 mb-4"> Developed a full-stack sports performance management platform implementing a complete Coach–Athlete 
workflow, enabling athletes to log biometric training data, menstrual cycle metrics, and nutrition 
information, which are processed into fatigue, training load, and readiness scores through a Random Forest
based analytics model. 
Engineered a scalable backend architecture with role-based authentication and RESTful APIs, powering real
time coach dashboards, performance trend visualization, wearable integration readiness (HealthKit/Google 
Fit), and data-driven training optimization.  </p>
              <div className="flex space-x-2">
      ...
      <footer className="bg-gradient-to-r from-purple-900 to-pink-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/Sreejith2601" className="hover:text-purple-300 transition-colors">
